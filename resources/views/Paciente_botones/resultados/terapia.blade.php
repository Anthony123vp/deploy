                ...
                <div class='contenedor_todo_3'>
                        ...
                        <div class='tercero_content_form'>
                            ...
                            <div class='case2'>
                                ...
                                <div class='case2_2'><textarea placeholder='Ingresa los signo vitales del paciente' name="objetivos_tratamiento" id="" require>{{$resultado->objetivos_tratamiento}}</textarea></div>
                                <input type="hidden" name='id_reserva' value='{{$reserva->id_reserva}}'>
                            </div><br>
                            <div class='case3'>
                                <div class='case3_1'><b>MODALIDAD DE TERAPIA RECOMENDADA</b></div>
                                <div class='case3_2'><textarea  require placeholder='Ingresa resultado del sistema cardiovascular del paciente' name="modalidad_terapia" id="">{{$resultado->modalidad_terapia}}</textarea></div>
                            </div><br>
                            <div class='case3'>
                                <div class='case3_1'><b>FRECUENCIA DE SESIONES</b></div>
                                <div class='case3_2'><textarea  require placeholder='Ingresa resultado del sistema cardiovascular del paciente' name="frecuencia_sesiones" id="">{{$resultado->frecuencia_sesiones}}</textarea></div>
                            </div><br>
                            <div class='case3'>
                                <div class='case3_1'><b>DURACION ESTIMADA DEL TRATAMIENTO</b></div>
                                <div class='case3_2'><textarea require placeholder='Ingresa resultado del sistema gastrointestinal del paciente' name="duracion_tratamiento" id="">{{$resultado->duracion_tratamiento}}</textarea></div>
                            </div><br>
                            <div class='case2'>
                                <div class='case2_1'><b>INTERVENCIONES TERAPEUTICAS SUGERIDAD</b></div>
                                <div class='case2_2'><textarea require placeholder='Ingresa resultado del sistema musculoesqueletico del paciente' name="intervenciones_terapeuticas" id="">{{$resultado->intervenciones_terapeuticas}}</textarea></div>
                            </div><br>
                            <div class='case2'>
                                <div class='case2_1'><b>RECOMENDACIONES DEL MEDICO</b></div>
                                <div class='case2_2'><textarea require placeholder='Ingresa resultado del sistema nervioso del paciente' name="recomendaciones" id="">{{$resultado->recomendaciones}}</textarea></div>
                            </div><br>
                        </div>
                        <br>
                        <br>
