...
@section('content')
    ...
    <div class="login-box">
        <p>Nueva Recepcionista</p>
        <form action="{{ route('recepcionistas.update', ['id' => $recepcionista->id_recepcionista]) }}" method="POST">
            @csrf
            @method('PUT')
            <div class='contenedor_flex'>
                <div class="user-box">
                    <input  value="{{ $recepcionista->nombres }}"  required="" name="nombres" type="text">
                    <label>Nombres</label>
                </div>
                <div class="user-box">
                    <input  value="{{ $recepcionista->ape_paterno }}"  required="" name="ape_paterno" type="text">
                    <label>Apellido Paterno</label>
                </div>
            </div>
            <div class='contenedor_flex'>
                <div class="user-box">
                    <input value="{{ $recepcionista->ape_materno }}" required="" name="ape_materno" type="text">
                    <label>Apellido Materno</label>
                </div>
                <div class="user-box">
                    <input  value="{{ $recepcionista->dni }}" required="" name="dni" type="number">
                    <label>DNI</label>
                </div>
            </div>
            <div class='contenedor_flex'>
                <div class="user-box">
                    <input value="{{ $recepcionista->celular }}" required="" name="celular" type="number">
                    <label>Celular</label>
                </div>
                <div class="user-box">
                    <input value="{{ $recepcionista->f_nacimiento }}" required="" name="f_nacimiento" type="date">
